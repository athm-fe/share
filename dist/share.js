...
Share.prototype.init = function () {
  ...
  that.$shareWb.on('click', function () {
    (function (s, d, e) {
      ...
      var p = ['url=', e(u), '&title=', e(that.sharetitle), '&appkey=2924220432', '&pic=', e(that.pic), '&url=', e(that.shareUrl)].join('');
      function a() {
  ...
  that.$shareQz.on('click', function () {
    (function (s, d, e) {
      ...
      var u = that.shareUrl;
      var p = ['url=', e(u), '&title=', e(that.sharetitle), '&appkey=2924220432', '&pics=', e(that.pic), '&summary=', e(that.summary), '&url=', e(that.shareUrl)].join('');
      function a() {
        if (!window.open([f, p].join(''), 'mb', ['toolbar=0,status=0,resizable=1,width=620,height=450,left=', (s.width - 620) / 2, ',top=', (s.height - 450) / 2].join(''))) u.href = [f, p].join('');
      }
      if (/Firefox/.test(navigator.userAgent)) {
